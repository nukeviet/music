...
$lang_module['check_link_manual'] = "Hãy tự kiểm tra";
...
$lang_module['delete_singer'] = "Xóa ca sĩ";
$lang_module['delete_author'] = "Xóa nhạc sĩ";
...
$lang_module['video_edit'] = "Sửa videoclip";
$lang_module['video_info'] = "Thông tin videoclip";
$lang_module['video_list'] = "Danh sách videoclip";
$lang_module['video_list_comment'] = "Danh sách các bình luận videoclip";
$lang_module['video_del_confirm'] = "Bạn có chắc xóa video này";
$lang_module['video_error_check'] = "Bạn chưa chọn video nào";
$lang_module['video_comment_edit'] = "Sửa bình luận videoclip";
...
$lang_module['vcat_lits'] = "Danh sách thể loại videoclip";
...
$lang_module['video_error_thumb'] = "Bạn chưa chọn ảnh cho videoclip";
...
$lang_module['tip_alias'] = "Tên ngắn gọn gọn là giá trị sẽ xuất hiện trên địa chỉ của trình duyệt khi truy cập nội dung, nếu không am hiểu về vấn đề này, tốt nhất hãy để hệ thống tự xác định";
...
$lang_module['tip_album_song'] = "Chọn một hoặc nhiều bài hát cho album, nhấp chuột vào tên bài hát và kéo thả để sắp xếp thứ tự các bài hát trong album";
$lang_module['tip_album_title'] = "Nhập tên cho album, nên viết hoa ký tự đầu tiên của mỗi từ, để đảm bảo tính thẩm mỹ";
