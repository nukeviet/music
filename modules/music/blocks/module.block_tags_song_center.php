...
global $module_file, $module_info, $mainURL, $lang_module, $db, $module_data, $module_name, $setting, $main_header_URL, $op, $array_op, $downURL, $category, $nv_Request, $nv_Cache;
