...
global $lang_module, $module_data, $module_file, $module_info, $mainURL, $db, $array_op, $op, $module_name, $nv_Cache;

if( $op == "listenone" )
{
	$xtpl = new XTemplate( "block_same_category.tpl", NV_ROOTDIR . "/themes/" . $module_info['template'] . "/modules/" . $module_file );
