...
$sql = "FROM " . NV_PREFIXLANG . "_" . $module_data . "_comment_video AS a INNER JOIN " . NV_PREFIXLANG . "_" . $module_data . "_video AS b ON a.what=b.id WHERE a.id!=0";
...
$xtpl->assign( 'URL_ACTIVE_LIST', "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=listactive&where=_comment_video" );
...
while( $row = $result->fetch() )
{
	...
	$xtpl->assign( 'song', $row['tname'] );

	$xtpl->assign( 'URL_DEL_ONE', $link_del . "&where=_comment_video&id=" . $row['id'] );
