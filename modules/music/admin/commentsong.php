...
$page_title = $lang_module['song_list_comment'];
...
$sql = "FROM " . NV_PREFIXLANG . "_" . $module_data . "_comment_song AS a INNER JOIN " . NV_PREFIXLANG . "_" . $module_data . " AS b ON a.what=b.id WHERE a.id!=0";
...
$link_edit = "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=editcomment&where=song";
$link_active = "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=active&where=_comment_song&id=";
...
while( $row = $result->fetch() )
{
	...
	$xtpl->assign( 'URL_DEL_ONE', $link_del . "&where=_comment_song&id=" . $row['id'] );
