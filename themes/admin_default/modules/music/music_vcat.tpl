	...
	<table class="table table-striped table-bordered table-hover">
		...
		<thead>
			<tr>
				...
				<td style="width:100px" class="text-center">{LANG.siteinfo_numvideo}</td>
		...
		<!-- BEGIN: row -->
			<tr>
				<td>
                    <select class="form-control music-input" name="weight" id="weight{ROW.id}" onchange="nv_change_vcat_weight({ROW.id});">
                        <!-- BEGIN: weight -->
				...
				<td class="text-center">{ROW.numvideo}</td>
