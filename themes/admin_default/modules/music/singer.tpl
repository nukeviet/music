		...
		<tr>
			<td>
				<form class="form-inline" id="filter-form" method="get" action="" onsubmit="return false;">
					<input class="form-control music-input text size2" type="text" name="q" value="{DATA_SEARCH.q}" placeholder="{LANG.filter_singer}"/>
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<!-- BEGIN: row -->
			<tr class="topalign">
				...
				<td class="text-center"><strong>{ROW.numalbum}</strong></td>
