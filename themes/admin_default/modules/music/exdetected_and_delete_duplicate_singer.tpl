...
<table class="table table-striped table-bordered table-hover">
	<thead>
		<tr>
			...
			<td style="width:100px">{LANG.album}</td>
			<td style="width:100px">{LANG.video}</td>
			<td class="text-center" style="width:50px">{GLANG.delete}<br /><input name="check_all[]" type="checkbox" value="yes" onclick="nv_checkAll(this.form, 'deleteid[]', 'check_all[]',this.checked);" /></td>
			<td class="text-center" style="width:50px">{LANG.ex_detected_and_delete_duplicate_singer_to}</td>
		</tr>
	</thead>
	<tbody>
	<!-- BEGIN: loop -->
	...
	<tfoot>
		<tr>
			<td colspan="8" class="text-center">
				<input class="btn btn-primary" type="submit" name="submit" value="{LANG.ex_do}"/>
			</td>
		</tr>
	</tfoot>
</table>
