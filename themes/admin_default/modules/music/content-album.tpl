		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><input id="idalias" name="ten" class="form-control music-input txt-half" value="{DATA.name}" type="text" original-title="{LANG.tip_alias}"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input name="casimoi" class="form-control music-input txt-half" type="text" original-title="{LANG.tip_new_singer}"/></td>
				</tr>
				<tr>
...
$(document).ready(function(){
	...
	$("a#addonesong").click(function(){
		...
		nv_open_browse( "{NV_BASE_ADMINURL}index.php?" + nv_name_variable + "=" + nv_module_name + "&findOneAndReturn=1&area=listsong-area&input=listsong&listsong=" + listsong, "NVImg", "850", "600", "resizable=no,scrollbars=no,toolbar=no,location=no,status=no" );
	});
	$("a#addlistsong").click(function(){
		var listsong = $("input[name=listsong]").attr("value");
		nv_open_browse( "{NV_BASE_ADMINURL}index.php?" + nv_name_variable + "=" + nv_module_name + "&findListAndReturn=1&area=listsong-area&input=listsong&listsong=" + listsong, "NVImg", "850", "600", "resizable=no,scrollbars=no,toolbar=no,location=no,status=no" );
	});
});
</script>
<!-- END: main -->