		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control music-input txt-half" id="idtitle" name="tenthat" value="{DATA.tenthat}" original-title="{LANG.tip_song_title}"/>
				...
				<tr>
					...
					<td><input type="text" class="form-control music-input txt-half" id="idalias" name="ten" value="{DATA.ten}" original-title="{LANG.tip_alias}"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input class="form-control music-input txt-half" name="album" id="album" type="text" readonly="readonly" value="{DATA.album}"/>
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control music-input txt-quater" name="bitrate" id="bitrate" value="{DATA.bitrate}"/> bps
						<input type="text" class="form-control music-input txt-quater" name="duration" id="duration" value="{DATA.duration}"/> {GLANG.sec}
						<input type="text" class="form-control music-input txt-quater" name="size" id="size" value="{DATA.size}"/> byte
					</td>
				</tr>
				<tr>
